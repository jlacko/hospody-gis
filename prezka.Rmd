...
# Přehled barů - heatmapa
--
```{r bary-dens, echo = F, cache = T, out.width = '85%', fig.align="left", fig.asp = 0.55, dpi = 150}
plot_bary_dens
```
---
...
# Základní model
```{r base-model,echo = F, cache = F, out.width = '85%', fig.align="left", fig.asp = 0.55, dpi = 150}
summary(model)
```
--
...
---
# Modifikovaný model
```{r engineered-model, echo = F, cache = F, out.width = '85%', fig.align="left", fig.asp = 0.55, dpi = 150}
summary(sl_model)
```
...
```{r leaflet-plot, echo = F, eval = T, cache = T, message = F, out.height='75%', out.width='100%'}
